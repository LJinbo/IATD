...
<div class="dealer form-container">
    <form method="post" @submit.prevent="onSubmit">
        <div class="input-group">
            <input type="text" placeholder="请输入经销商" v-model.trim="dcode" required>
    ...
    methods: {
        onSubmit() {
            if(!/^[1][3,4,5,7,8][0-9]{9}$/.test(this.iphone)){
                ...
                this.$post('/api/WxWeb/UserLogin',{'User_Role_Type':'3','User_Name': this.dcode,'User_Cell': this.iphone}).then( res =>{
                    console.log(res);
